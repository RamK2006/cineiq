...
def test_log_exception_minimal_fields() -> None:
    ...
    # structlog uses positional event name + **kwargs
...
def test_log_exception_traceback_includes_call_stack() -> None:
    ...
    # The traceback should contain the function name and the error message
...
def test_log_exception_timestamp_is_isoformat() -> None:
    ...
    # ISO-8601 format contains 'T' separator and ends with 'Z' or timezone offset
    assert "T" in ts
    # Must be parseable
